...
const Header = () => {
  ...
  return (
    <header className="bg-slate-500 z-10 border-b-[1px] sticky top-0 text-white backdrop-blur-lg  px-5 py-10  flex items-center justify-between">
      <div className="">
        <h2
          onClick={() => navigate("/")}
          className="font-extrabold text-[26px] cursor-pointer tracking-wide sm:tracking-widest font-bold "
        >
          Craftopia
        </h2>
      </div>
